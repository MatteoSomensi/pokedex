...
class PokemonListViewModelTest {
    ...
    @Test
    fun `initial state loads types successfully`() =
    ...
    @Test
    fun `OnSearchQueryChanged updates state query`() =
        runTest(mainDispatcherExtension.testDispatcher) {
    ...
    @Test
    fun `OnTypeFilterSelected updates state selectedType`() =
        runTest(mainDispatcherExtension.testDispatcher) {
    ...
    @Test
    fun `OnPokemonClicked emits NavigateToDetail effect`() =
        runTest(mainDispatcherExtension.testDispatcher) {
